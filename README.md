...
A cross-platform Flutter experience that showcases an animated onboarding flow,
location-aware welcome screen, and alarm scheduling with local notifications.
